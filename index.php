...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link rel="icon" sizes="192x192" href="http://sode-edu.in/wp-content/themes/sodeCollege2015/images/sode-logo.png">

    <!-- Add to homescreen for Safari on iOS -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <link rel="apple-touch-icon-precomposed" href="http://sode-edu.in/wp-content/themes/sodeCollege2015/images/sode-logo.png">

    <!-- Tile icon for Win8 (144x144 + tile color) -->
    <meta name="msapplication-TileImage" content="http://sode-edu.in/wp-content/themes/sodeCollege2015/images/sode-logo.png">
  ...
  <title>Shri Madhwa Vadiraja Institute of Technology &amp; Management</title>
...
header {
 ...
 width: 100%%;
	...
	background: #e55d87;
	background: -moz-linear-gradient(-45deg, #000000 0%, #5fc3e4 100%);
	background: -webkit-linear-gradient(-45deg, #000000 0%, #5fc3e4 100%);
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li><a class="smoothscroll" href="#guidelines">Guidelines</a></li>
          <li><a class="smoothscroll" href="#schedule">Schedule</a></li>
          <li><a class="smoothscroll" href="#team">Team</a></li>
          <li><a class="smoothscroll" href="#registration">Registration</a></li>
...
<g class="atom">
	<path fill="#FF0000" d="M204.035,252.4c-9.988,0-17.812-21.622-17.812-49.225c0-27.599,7.824-49.219,17.812-49.219
	...
	<path fill="#4c4cff" d="M172.597,232.828c-5.347,0-9.068-1.491-10.761-4.312c-2.5-4.16-0.378-10.7,5.974-18.417
	...
	<path fill="#ffffff" d="M235.32,231.218c-10.358,0-25.183-4.604-39.655-12.314c-24.36-12.975-39.768-30.046-35.076-38.865
...
<g class="piggy">
    ...
    <h1 class="heading">IIoT 2k17</h1>
    <h2 class="heading">Industrial Internet of Things - 2k17</h2>
...
<section id="about">
  <div class="container">
    <div class="row">
      <h1>About</h1>
      <div class="block"></div>
      <p>Internet of Things (IoT) is a trending and buzzword, which has created lot of
excitement among the corporate sector, academia, research scholars and
scientific community. It is envisioned as the next big revolution in the
technical landscape. It deals with the network of physical objects or “things”
embedded with electronics, software, sensors and network connectivity,
which enables these objects to collect and exchange data. The advantages
and capabilities of IoTare multifarious.
The interconnection of devices will lead to a major paradigm shift, where the
world will be heading towards an automated era, which will pave the way for
new vertical and horizontal in the industry.
The Internet of Things will include around 26 billion units installed by 2020,
as predicted by Gartner.</p>

<p>When a huge number of devices are being connected to existing network
infrastructure, lot of open challenges will be thrown at technical community
such as architecture and dependencies, massive scaling of devices,
knowledge discovery and analytics of big data, standards for device
monitoring and management, interoperability, data security and privacy
etc. for the IoTplatform.</p>



<p>To address these open challenges, we at Shri Madhwa Vadiraja Institute of
Technology & Management are organizing a “State Level Student
Symposium and Project Exhibition Industrial Internet of Things
(IIOT-2K17)” on November 10, 2017.</p>
    ...
    <div class="row">
	  ...
	  <h3><span class="typcn typcn-device-desktop icon"></span>A Glimpse of IOT 2K15</h3>
	  <div class="block"></div>
        <p>The Internet of Things (IOT) refers to the networking of physical objects
through the use of embedded sensors, actuators, and other devices that
can collect or transmit information about the objects.
Applications based on this emerging technology are increasingly being
introduced in a number industries such as healthcare, smart home and
office solutions, automobile, pharmaceuticals, electronic gadgets, retail,
industrial automation, smart scientific products, education, agriculture,
traffic management, gas and water supply system etc.
The Multifunctional Smart Fitness Band, explores the potential of the
technology. The device offers a wide range of applications in the healthcare
sector and is capable of measuring and monitoring several vital physical
parameters such as heart rate, temperature, energy burnt etc.</p>
      </div>
      <div class="six columns">
        <h3><span class="typcn typcn-device-desktop icon"></span>A Glimpse of IIOT 2K16</h3>
		<div class="block"></div>
        <p>Passing on the good work initiated from the Inter-Department
competition held during August, 2015, “State Level student symposium
cum project exhibition, IIOT 2K16” was held in the month of November
2016. More than 30 teams from all over Karnataka participated in this
event. Varieties of projects were displayed and many exciting prizes were
distributed.
Many of the projects were applicable in all aspects of daily life. Models of
Process Automation, Agri Copter, Automated Paddy Trans-planter to
support the farmers, Automation Dry-Wet Waste collection to support
Swach Bharath Abhiyan, were few from the projects exhibited in this forum.
The driving philosophy behind the IIOT 2K16 was to motivate the young
minds to work together and exhibit their real talents,also to think towards
building some smarter appliances using the trending technology of Internet
of Things to help the larger community to get an appropriate solution to their
real life issues. </p>
      </div>
...
<section id="guidelines">
  <div class="container">
    <h1>Guidelines for Project Submission</h1>
    <div class="block"></div>
	
	
	<p>Each team may comprise minimum one member and a maximum of four
members. Interdisciplinary teams comprising members from different
branches are also allowed.
</p>
	
	<p>Only working project models are allowed at the competition. Poster or
paper presentation will not be allowed.</p>
	
	<p>Each team must submit the general electrical and networking
infrastructure required for their project demonstration along with the
registration form.</p>
	
	<p>The project report has to be prepared in MS Word document and must
reach the given contact email id on or before last date of registration.</p>
	
	<p>Students may select the following areas for ideating and developing the
projects for the competition: </p>
	
	<ul>
			  <li>Civil Engineering Solutions (Next generation home, ERP for construction
management, Smart Traffic management, Smart Inland Waterways,
CRM for highway management, SCMfor Construction material supply)</li>

			  <li>Automobile industry Industrial automation (Industrial production,
sale and maintenance controls, Smart cars)</li>

			  <li>Health care units (Personal and Home health care, Hospitals, Patient
monitoring systems, Baby care systems).</li>

			  <li>Pharma solutions (Drug distribution and production network)</li>
			  
			  <li>Electronics and mobile industry (Smart gadgets with IOT enabled,
Smart Lighting)</li>

			  <li>Retail industry (Smart cart)</li>
			  
			  <li>Scientific products (Smart Meter, Smart Thermometer)</li>
			  
			  <li>Agro Industry and equipment (Connected tractor, smart irrigation system)</li>
			  
			  <li>Education (Students progress and attendance monitoring system,
Smart Lab)</li>

			  <li>Agriculture solutions (Smart water and fertilizer feeding system)</li>
			  
			  <li>Auto Water supply and control systems for City</li>
			  
			  <li>Vehicle monitoring system (Remote speed control, real time location and
security)</li>

			  <li>Logistics (DHL, Blue dart)</li>
			  
			  <li>Defence Industry (Smart surveillance, Smart fencing, Smart drones, IOT
aided robotics in military environment )</li>

			  <li>Aviation Industry (Smart baggage tracking, Smart ATC, Smart ground
attendant, Smart passenger preference)</li>
...
<section id="schedule">
  <div class="container">
   <link rel="stylesheet" href="css/table.css"><br><br>
   <h1>Schedule</h1>
   <div class="block"></div>
  <h4>Schedule Of Events For IIOT-2k17 On 10th November, 2017</h4>
    ...
    <tbody>
      <tr>
	   ...
	   <tr>
        ...
        <td>Key Note Address by<br>
			<b>Dr. Narendranath Udupa</b>,<br>
Head,<br> Department of Lighting Research at Philips Lighting, Bengaluru.<br><br>
		Topic:
		<b>	“IoT in Smart Cities and Lighting”</b>	
		</td>
      </tr>
	   ...
	   <tr>
        ...
        <td>Session-I by<br>
<b>Mr. Bhuvan K Shetty</b><br>
Senior Manager,<br>
Enterprise Internet of Things (IoT),<br>
Bosch Engineering and Business Solutions,Bengaluru.<br><br>

Topic:
<b>“IoT and Blockchain”</b>
</td>
      </tr>
	  ...
	  <tr>
        ...
        <td>Session- II by<br>
<b>Dr. Mohith P Tahiliani</b>,<br>
Assistant Professor,<br>
Dept. of CSE, NITK Suratkal<br><br>

Topic:
<b>“IoT Architecture and Protocols.”</b>
</td>
      </tr>
	  
	  <tr>
        <td>6</td>
        <td>02.45 PM - 03.30 PM</td>
        <td>Session- III by<br>
<b>Prof. Rajeev Srivastava</b>,<br>
Head of the Dept. of CSE,<br> IIT (BHU) Varanasi<br><br>

Topic:
<b>“Image processing, Computer Vision and its medical Applications : A machine learning perspective”</b>
</td>
      </tr>
	  
	  <tr>
        <td>6</td>
        <td>03.30 PM - 03.45 PM</td>
        <td>High Tea</td>
      </tr>
	  ...
	  <tr>
        <td>8</td>
        <td>09.15 AM - 03.30 PM</td>
        <td>Project Exhibition which will be parallel with the Symposium.<br>
<b>Judges are:</b><br> 
1. <b>Dr. Radhika M Pai</b>, MIT Manipal.<br>
2. <b>Karthik K</b>, Robosoft Udupi.<br>
3. <b>Dr. D K Sreekantha</b>, NMAMIT, Nitte</br>
</td>
      </tr>
	</tbody>
  </table>
...
<section id="team">
  <div class="container">
	 ...
	 <div class="row">
		...
		<div class="three columns"> 		<h1>Chairman</h1><div class="block"></div>
<img src="http://sode-edu.in/wp-content/uploads/2015/02/THIRUMALESHWARA-BHAT-MECH.jpg" width=220; height=160; alt=""/>
        <h5><strong>Dr. Thirumaleshwara Bhat</strong></h5> 
		<h6>Principal, SMVITM</h6> 
       </div>
		
		
      <div class="three columns"> 		<h1>Convener</h1><div class="block"></div>
<img src="http://sode-edu.in/wp-content/uploads/2015/01/Vasudeva-cs-2.jpg" width=220; height=160; alt=""/>
        <h5><strong>Dr. Vasudeva</strong></h5> 
		<h6>Head, Dept. of CS& Engg., SMVITM</h6> 
       </div>
...
<img src="http://sode-edu.in/wp-content/uploads/2015/01/RAMA-MOORTHY-CS.jpg" width=220; height=220; alt=""/>
        <h5><strong>Mr. Rama Moorthy H</strong></h5> 
		<h6>Asst. Professor, Dept. of CS& Engg., SMVITM</h6> 
		<h6>9845676359</h6> 
		</div>
      
	  <div class="three columns"> <img src="http://sode-edu.in/wp-content/uploads/2015/01/MANAOJ-T-CS.jpg" width=220; height=220;  alt=""/>
        <h5><strong>Mr. Manoj T</strong></h5>
		<h6>Asst. Professor, Dept. of CS& Engg., SMVITM</h6> 
		<h6>9481845229</h6> 
        </div>
    
     <div class="three columns"> <img src="http://sode-edu.in/wp-content/uploads/2015/02/SACHIN-BHAT-EC.jpg" width=220; height=220;  alt=""/>
        <h5><strong>Mr. Sachin Bhat</strong></h5>
		<h6>Asst. Professor, Dept. of E&C Engg., SMVITM</h6> 
		<h6>9480789514</h6> 
       </div>
	...
	<div class="row">
      ...
      <div class="three columns"> <img src="" width=220; height=220; alt=""/>
        <h4><strong>Ms. Ashwini</strong></h4> 
		<h6>Dept. of CSE, SMVITM</h6> 
		<h6>9902430010</h6> 
      </div>
      
	  <div class="three columns"> <img src="" width=220; height=220;  alt=""/>
        <h4><strong>Mr. Yashasvi Shenoy</strong></h4>
		<h6>Dept. of ECE, SMVITM</h6>
		<h6>8861027757</h6> 		
        </div>
...
<section id="testimonial">
  <div class="container">
    <div class="quoteLoop">
      <blockquote class="quote"> <!--<img src="https://s3-eu-west-1.amazonaws.com/sixtybidresources/iot/ericsson.png" width="100" height="100" alt=""/>-->
        <h5>&nbsp;<br>
          &rdquo;It's our own ability to have an idea and go after the idea and make it happen. That's what at the end of the day defines us.&rdquo;<br>
          <small>Satya Nadella, CEO of Microsoft</small></h5>
      </blockquote>
	  
      <blockquote class="quote"> <!--<img src="https://s3-eu-west-1.amazonaws.com/sixtybidresources/iot/ericsson.png" width="100" height="100" alt=""/>-->
        <h5>&nbsp;<br>
          &rdquo;There is a huge need and a huge opportunity to get everyone in the world connected, to give everyone a voice and to help transform society for the future. The scale of the technology and infrastructure that must be built is unprecedented, and we believe this is the most important problem we can focus on.&rdquo;<br>
          <small>Mark Zuckerberg, CEO of Facebook</small></h5>
      </blockquote>
	  
	  <blockquote class="quote"> <!--<img src="https://s3-eu-west-1.amazonaws.com/sixtybidresources/iot/ericsson.png" width="100" height="100" alt=""/>-->
        <h5>&nbsp;<br>
          &rdquo;It's a world of multiple screens, smart displays, with tons of low-cost computing, with big sensors built into devices. At Google, we ask how to bring together something seamless and beautiful and intuitive across all these screens.&rdquo;<br>
          <small>Sundar Pichai, CEO of Google</small></h5>
      </blockquote>
...
<section id="registration"> 
  <div class="container">
    ...
    <h1>Registration</h1>
    <div class="block"></div>
	    <h6>Last Date for Registration: 02 November 2017</h6>
...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeDi0XthaZtnDTZ64ywEZ-nIePed-pWPrFf9Xw_9hdnFTHA1g/viewform?embedded=true" width="80%" height="1350" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>	
	<br>
	<br>
	
	<div class="full pcontent">
        
<a href="http://sode-edu.in/wp-content/uploads/2017/09/IIOTbrochure2017.pdf"><img class="alignleft wp-image-14113" src="http://sode-edu.in/wp-content/uploads/2017/09/index1.png" rel='prettyPhoto[pp_gal]' alt="" width="200" height="133" /></a></h3>
    </div>
...
<footer>
  <div class="container">
      ...
      <p>Designed and Developed By Rajath</p>
    
    
	<a href="https://twitter.com/rajath_ryk"><span class="typcn typcn-social-twitter-circular socialIcons" ></span></a>
	<a href="https://github.com/Rajath4"><span class="typcn typcn-social-github-circular socialIcons"></span></a>
	<a href="https://plus.google.com/u/0/102109748045544221212"><span class="typcn typcn-social-google-plus-circular socialIcons"></span></a>
	<a href="https://www.linkedin.com/in/rajathyk/"><span class="typcn typcn-social-linkedin-circular socialIcons"></span></a> 
